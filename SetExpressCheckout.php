    ...
    <table class="api">
        ...
        <tr>
					<td class="field">
						Producto 1:</td>
					<td>
						<input type="text" size="30" maxlength="32" name="L_NAME1" value="Pantalla de LED 50 Pulgadas Samsung 60 Hz 1080p FHD Smart UN50FH5303FXZX
" /></td>


				<td class="field"> Monto:  </td>
				<td>
					<input type="text" name="L_AMT1" size="5" maxlength="32" value="11112.07" /> </td>
			 ...
			 <tr>
					<td class="field">
						Producto 2:</td>
					<td>
						<input type="text" size="30" maxlength="32" name="L_NAME0" value="Impresora Samsung Mod. SL-M2022/XAX" /> </td>


				<td class="field">
					Monto: <br /> </td>
				<td>
					<input type="text" name="L_AMT0" size="5" maxlength="32" value="688.79"  /> </td>
