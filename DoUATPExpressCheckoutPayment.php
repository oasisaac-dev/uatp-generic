...
//$nvpstr='&TOKEN='.$token.'&PAYERID='.$payerID.'&PAYMENTACTION='.$paymentType.'&AMT='.$paymentAmount.'&CURRENCYCODE='.$currCodeType.'&IPADDRESS='.$serverName. '&SHIPTONAME=Brian Gutierrez&SHIPTOSTREET=Calle 1&SHIPTOSTREET2=Colonia&SHIPTOCITY=Cuautla&SHIPTOSTATE=Morelos&SHIPTOZIP=62748&SHIPTOCOUNTRYCODE=MX&SHIPTOPHONENUM=5558811396';
//echo $nvpstr;
//exit();
 ...
 /* Make the call to PayPal to finalize payment
    ...
    */
$resArray=hash_call("DoUATPExpressCheckoutPayment",$nvpstr);
